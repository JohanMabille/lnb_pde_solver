...
```bash
git clone https://github.com/JohnDoe/lnb_pde_solver.git
cd lnb_pde_solver
git remote add upstream https://github.com/JohanMabille/lnb_pde_solver.git
```
...
First, be sure you master is up to date; on your remote fork on github (here `JohnDoe/lnb_pde_solver`)
you should see `This branch is even with JohanMabille/lnb_pde_solver`. If not, you need to update:
